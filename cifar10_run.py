# -*- coding: utf-8 -*-
"""
Created on Fri Jan 14 19:16:44 2022

@author: Zhong-Jing
@co-author: Eduin Hernandez
Summary: Trains Multiple Classifications models and extracts the gradients for storage and future use.
"""
import argparse
...
def parse_args():
    ...
    parser.add_argument('--trial-end-idx', type=int, default=10, help='Simulation end index')
